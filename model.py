...
#print(test.formatteddata())
print(test.probability(('the','ball','and')))
#print(test.frequency)



print(test.perplexity(['the','ball','and']))
print(test.perplexity(['and','the','ball']))
print(test.perplexity(['ccccc','ball','ca']))


#print(test.unigram())

print(test.choose_successor(['and','she']))
